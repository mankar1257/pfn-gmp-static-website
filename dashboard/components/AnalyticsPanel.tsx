            ...
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={stats.chartData.filter(d => d.seats > 0)} margin={{ top: 5, right: 10, left: -20, bottom: 5 }}>
                ...
                <Tooltip
                  ...
                  formatter={(value: number | undefined, name: string | undefined) => [value ?? 0, name === 'seats' ? 'Projected' : 'Baseline']}
                />
            ...
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                ...
                <Tooltip
                  ...
                  formatter={(value: number | undefined, name: string | undefined) => [`${value ?? 0} seats`, name ?? '']}
                />
              </PieChart>
            </ResponsiveContainer>
          </div>
