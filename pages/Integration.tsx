      ...
      <section className="py-16 bg-slate-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-slate-300">
            Get <span className="text-neon-400 font-semibold">PFN</span> running in your project in minutes
          </p>
        </div>
      </section>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <a href="mailto:sarvin@null-field.com" className="text-neon-600 hover:text-neon-500 font-medium">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="bg-slate-900 rounded-xl p-4 font-mono text-sm text-neon-400">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-slate-50 rounded-2xl p-6 border border-slate-200 text-center">
              <Terminal className="h-10 w-10 text-neon-600 mx-auto mb-4" />
            ...
            <div className="bg-slate-50 rounded-2xl p-6 border border-slate-200 text-center">
              <Package className="h-10 w-10 text-neon-600 mx-auto mb-4" />
            ...
            <div className="bg-slate-50 rounded-2xl p-6 border border-slate-200 text-center">
              <Settings className="h-10 w-10 text-neon-600 mx-auto mb-4" />
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-slate-800 rounded-2xl p-6 border border-slate-700">
              <h3 className="text-lg font-bold text-neon-400 mb-4">Core Operations</h3>
              <ul className="space-y-2 font-mono text-sm">
                <li className="text-slate-300"><span className="text-neon-400">pfn_add</span>(a, b) — Addition</li>
                <li className="text-slate-300"><span className="text-neon-400">pfn_sub</span>(a, b) — Subtraction</li>
                <li className="text-slate-300"><span className="text-neon-400">pfn_mul</span>(a, b) — Multiplication</li>
                <li className="text-slate-300"><span className="text-neon-400">pfn_div</span>(a, b) — Division</li>
                <li className="text-slate-300"><span className="text-neon-400">pfn_pow</span>(a, n) — Power</li>
              </ul>
            </div>
            <div className="bg-slate-800 rounded-2xl p-6 border border-slate-700">
              <h3 className="text-lg font-bold text-neon-400 mb-4">Utilities</h3>
              <ul className="space-y-2 font-mono text-sm">
                <li className="text-slate-300"><span className="text-neon-400">pfn_from_string</span>(s) — Parse</li>
                <li className="text-slate-300"><span className="text-neon-400">pfn_to_string</span>(a) — Format</li>
                <li className="text-slate-300"><span className="text-neon-400">pfn_cmp</span>(a, b) — Compare</li>
                <li className="text-slate-300"><span className="text-neon-400">pfn_scale</span>(a, n) — Scale by 10^n</li>
                <li className="text-slate-300"><span className="text-neon-400">pfn_free</span>(a) — Cleanup</li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-2xl p-8 border border-slate-200 shadow-lg">
            <div className="flex items-start gap-4">
              <div className="bg-neon-500/20 rounded-xl p-3">
                <BookOpen className="h-6 w-6 text-neon-600" />
              </div>
              <div>
                ...
                <Link to="/contact" className="text-neon-600 hover:text-neon-500 font-medium">
                  Contact our team →
                </Link>
              </div>
            </div>
